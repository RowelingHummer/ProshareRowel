...
$formulario = array("Editar Perfil","w3-text-proshare-n w3-xxxlarge w3-center","w3-text-proshare-a ","funcion()","");/** nombre , clases , accion */
$submit = array("Guardar","w3-button w3-large w3-block w3-section w3-proshare-n w3-ripple w3-padding w3-hover-proshare-a w3-hover-text-proshare-n");/** nombre , clases */
...
<div class="">
    <?php
    $formularioEditarPerfil = new formulario($formulario, $submit,$camposFormulario,$camposSelect);
